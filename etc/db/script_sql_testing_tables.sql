...
insert into possible_answer (id,text_answer,correct_answer,questions_id)
...
on  possible_answer.id  =  answer_question.possible_answer_question_id and correct_answer = '1' ;